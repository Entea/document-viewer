...
DV.DragReporter.prototype.stop = function () {
    ...
    var top = api ? api.getContentPositionY() : 0;
...
DV.model.Document.prototype = {
    ...
    setPageIndex: function (index) {
        ...
        _.each(this.onPageChangeCallbacks, function (c) {
            c();
        });
        return index;
    },
    ...
    computeOffsets: function () {
        ...
        if ('InitialLoad' == this.viewer.state) {
            return;
        }
...
DV.Api.prototype = {
    ...
    setSections: function (sections) {
        sections = _.sortBy(sections, function (s) {
            return s.page;
        });
            ...
            _.each(this.viewer.models.document.originalPageText, function (originalPageText, pageNumber) {
                ...
                if (originalPageText != pageText[pageNumber - 1]) {
                    ...
                    if (pageNumber == self.currentPage()) {
                        self.viewer.events.openTextPage();
                    }
                }
            });
        }
    ...
    /**
     * Unloads the current viewer
     * @param destroyHtml Remove the html elment
     */
    unload: function (destroyHtml) {
    ...
    enterEditPageTextMode: function () {
        ...
        this.viewer.events.openTextPage();
    },
